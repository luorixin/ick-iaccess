var IAX_CHART_TOOL = {
  ...
  initAudienceFunnel: function(id, data){
    ...
    //重组顺序，potential要在brand前面
    var newSeries = [],newSeriesJson={};
    for (var i = 0; i < series.length; i++) {
      if (series[i].name=="Brand" || series[i].name=="Potential") {
    ...
    var option = {
        ...
        color:['#FFBD00', '#EF4136', '#4484CF', '#946EDB', '#8D7B7B', '#54C7B0','#F47920','#194283','#59C754'],
        tooltip : {
            trigger : 'item',
            backgroundColor : "#f2f2f2",
            borderColor : "#dfdfdf",
