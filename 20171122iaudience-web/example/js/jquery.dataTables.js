...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var select = $('<div class="dropdown" style="display:inline-block;"></div>');
		var input = $('<input/>', {
		...
		for ( var i=0, ien=lengths.length ; i<ien ; i++ ) {
			ul.append('<li value="'+lengths[i]+'"><a href="javascript:;">'+language[i]+'</a></li>');
		}
		select.append('<button class="btn  dropdown-toggle" style="min-width:60px;" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">'+language[0]+'<span class="caret arrow-down"></span>');
		select.append(ul);
		...
		//修改select样式，把'select'替换成'input'
		$('input', div)
			.val( settings._iDisplayLength )
			.bind( 'change.DT', function(e) {
				_fnLengthChange( settings, $(this).attr("value") );
				_fnDraw( settings );
			} );
