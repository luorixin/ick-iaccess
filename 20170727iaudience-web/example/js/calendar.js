function xmoCalendar(options){
  ...
  // 指定放的位置
  _this.$wrapContainer = options['wrapContainer'] || $('body');
...
xmoCalendar.prototype.init_html = function(){
  ...
  if(_this.type == "single"){
	  $(".xmoCalendarMainHead","#"+_this.boxId).css("height","0");
	  $(".xmoCalendarMainHead .span","#"+_this.boxId).hide();
  }
...
xmoCalendar.prototype.showCalendar = function(month, year){
  ...
  var mask = $('<div id="mask"></div>').css({"z-index":100000,height:_this.$maskContainer.height(),width:_this.$maskContainer.width()}).click(function(){
